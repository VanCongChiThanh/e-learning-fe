...
import { useQuizzesByLecture, useDeleteQuiz } from "../hook/useQuizOperations";
...
const CourseQuizManagement: React.FC = () => {
  ...
  // const averageScore =
  //   quizzes.length > 0
  //     ? Object.values(quizStats).reduce(
  //         (sum: number, stat: any) => sum + (stat.averageScore || 0),
  //         0
  //       ) / quizzes.length
  //     : 0;
  // const totalQuestions = quizzes.reduce(
  //   (acc, quiz) => acc + (quiz.numberQuestions || 0),
  //   0
  // );
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-gray-600 mt-2">
                Tạo và quản lý các bài quiz cho khóa học
              </p>
            </div>
            <button
        ...
        <div className="bg-white rounded-lg shadow-md p-6 mb-6">
          ...
          {(!selectedSessionId || !selectedLectureId) && (
            <div className="mt-4 text-orange-600 text-sm bg-orange-50 px-3 py-2 rounded-lg">
              ...
              Chọn đầy đủ chương → bài giảng để xem danh sách quiz và tạo quiz
              mới
            </div>
          )}
        </div>
        ...
        <div className="bg-white rounded-lg shadow">
          <div className="px-6 py-4 border-b border-gray-200">
            <h2 className="text-xl font-semibold text-gray-900">
              Danh sách Quiz
              {selectedLectureId &&
                lectures.find((l) => l.lectureId === selectedLectureId) && (
            ...
            {!selectedLectureId ? (
              <div className="text-center py-12">
                ...
                <h3 className="mt-2 text-sm font-medium text-gray-900">
                  Chọn bài giảng để xem quiz
                </h3>
                <p className="mt-1 text-sm text-gray-500">
                  Vui lòng chọn chương và bài giảng cụ thể để xem danh sách quiz
                  thuộc bài giảng đó.
                </p>
              </div>
            ) : // loading ? (
