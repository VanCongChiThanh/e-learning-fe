...
const StudentProgressDetail: React.FC = () => {
  ...
  const [studentReport, setStudentReport] = useState<EnrollmentReport | null>(null);
  ...
  useEffect(() => {
    const reports = enrollments as EnrollmentReport[];
    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="text-center">
          <p className="text-gray-600 mb-4">Không tìm thấy thông tin học viên</p>
          <button
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-600 mt-2">
            {studentReport.userEmail} - {course?.name || course?.title || 'N/A'}
          </p>
        </div>
        ...
        <div className="bg-white rounded-lg shadow p-6 mb-8">
          <div className="flex items-center justify-between">
            <div>
              <h2 className="text-xl font-semibold text-gray-900">Thông tin học viên</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
          <div className="bg-white rounded-lg shadow p-6">
            <div className="flex items-center">
              ...
              <div className="ml-4">
                <p className="text-2xl font-semibold text-gray-900">{studentReport.progressPercentage}%</p>
          ...
          <div className="bg-white rounded-lg shadow p-6">
            <div className="flex items-center">
              ...
              <div className="ml-4">
                <p className="text-2xl font-semibold text-gray-900">{studentReport.averageQuizScore?.toFixed(1)}%</p>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-8">
          {/* Quiz Performance */}
          <div className="bg-white rounded-lg shadow p-6">
            <h3 className="text-lg font-semibold text-gray-900 mb-4">Thành tích Quiz</h3>
            <div className="space-y-4">
              <div className="flex justify-between items-center">
                <span className="text-gray-600">Tổng số Quiz:</span>
                <span className="font-semibold">{studentReport.totalQuizzes}</span>
              </div>
              <div className="flex justify-between items-center">
                <span className="text-gray-600">Đã hoàn thành:</span>
                <span className="font-semibold text-blue-600">{studentReport.completedQuizzes}</span>
              </div>
              <div className="flex justify-between items-center">
                <span className="text-gray-600">Đã qua:</span>
                <span className="font-semibold text-green-600">{studentReport.passedQuizzes}</span>
              </div>
              <div className="flex justify-between items-center">
                <span className="text-gray-600">Điểm trung bình:</span>
                <span className="font-semibold text-purple-600">{studentReport.averageQuizScore?.toFixed(1)}%</span>
              </div>
              {studentReport.totalQuizzes > 0 && (
                <div className="mt-4">
                  <div className="flex justify-between text-sm text-gray-600 mb-1">
                    <span>Tiến độ Quiz</span>
                    <span>{Math.round((studentReport.completedQuizzes / studentReport.totalQuizzes) * 100)}%</span>
                  </div>
                  <div className="w-full bg-gray-200 rounded-full h-2">
                    <div 
                      className="bg-green-600 h-2 rounded-full"
                      style={{ width: `${(studentReport.completedQuizzes / studentReport.totalQuizzes) * 100}%` }}
                    ></div>
                  </div>
                </div>
              )}
          ...
          <div className="bg-white rounded-lg shadow p-6">
            <h3 className="text-lg font-semibold text-gray-900 mb-4">Thành tích Bài tập</h3>
            <div className="space-y-4">
              <div className="flex justify-between items-center">
                <span className="text-gray-600">Tổng số bài tập:</span>
                <span className="font-semibold">{studentReport.totalAssignments}</span>
              </div>
              <div className="flex justify-between items-center">
                <span className="text-gray-600">Đã nộp:</span>
                <span className="font-semibold text-blue-600">{studentReport.submittedAssignments}</span>
              </div>
              <div className="flex justify-between items-center">
                <span className="text-gray-600">Đã chấm:</span>
                <span className="font-semibold text-orange-600">{studentReport.gradedAssignments}</span>
              </div>
              <div className="flex justify-between items-center">
                <span className="text-gray-600">Điểm trung bình:</span>
                <span className="font-semibold text-purple-600">{studentReport.averageAssignmentScore?.toFixed(1)}%</span>
              </div>
              {studentReport.totalAssignments > 0 && (
                <div className="mt-4">
                  <div className="flex justify-between text-sm text-gray-600 mb-1">
                    <span>Tiến độ bài tập</span>
                    <span>{Math.round((studentReport.submittedAssignments / studentReport.totalAssignments) * 100)}%</span>
                  </div>
                  <div className="w-full bg-gray-200 rounded-full h-2">
                    <div 
                      className="bg-orange-600 h-2 rounded-full"
                      style={{ width: `${(studentReport.submittedAssignments / studentReport.totalAssignments) * 100}%` }}
                    ></div>
                  </div>
                </div>
              )}
        ...
        <div className="bg-white rounded-lg shadow p-6 mb-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div>
              <h4 className="text-sm font-medium text-gray-500">Ngày đăng ký</h4>
            ...
            {studentReport.lastAccessedAt && (
              <div>
                <h4 className="text-sm font-medium text-gray-500">Truy cập cuối</h4>
                <p className="mt-1 text-sm text-gray-900">
            ...
            {studentReport.completionDate && (
              <div>
                <h4 className="text-sm font-medium text-gray-500">Ngày hoàn thành</h4>
                <p className="mt-1 text-sm text-gray-900">
        ...
        {studentReport.hasCertificate && (
          <div className="bg-white rounded-lg shadow p-6">
            ...
            <div className="flex items-center space-x-4">
              ...
              <div>
                <p className="text-lg font-medium text-gray-900">Chứng chỉ đã được cấp</p>
                {studentReport.certificateNumber && (
                  <p className="text-sm text-gray-600">Số chứng chỉ: {studentReport.certificateNumber}</p>
                )}
