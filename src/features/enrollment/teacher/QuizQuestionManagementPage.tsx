...
//     useState<QuizQuestionAnswerResponse | null>(null);
...
//       const hasOptions = bulkFormData[i].options.some(
//         (option) => option.trim() !== ""
//       );
//       if (!hasOptions) {
...
//                   {quizInfo.timeLimitMinutes || "Không giới hạn"}{" "}
//                   {quizInfo.timeLimitMinutes ? "phút" : ""}
//                 </p>
//               </div>
//               <div>
//                 <span className="text-sm text-gray-500">Số lần làm:</span>
//                 <p className="font-medium">
//                   {quizInfo.maxAttempts || "Không giới hạn"}{" "}
//                   {quizInfo.maxAttempts ? "lần" : ""}
//                 </p>
//               </div>
//               <div>
...
//                       Đáp án đúng:{" "}
//                       <strong>
//                         {["A", "B", "C", "D"][question.correctAnswerIndex]}
//                       </strong>
//                     </span>
//                     <span>
//                       Điểm: <strong>{question.points}</strong>
//                     </span>
//                     <span>
//                       Thứ tự: <strong>{question.sortOrder}</strong>
//                     </span>
//                   </div>
//                 </div>
//               ))}
...
//                 Bắt đầu bằng cách thêm câu hỏi đầu tiên cho quiz này.
//               </p>
//               <div className="mt-6">
//                 <button
//                   onClick={() => {
