...
const FeaturedCourseCard = ({ course }: { course: any }) => (
  ...
  <div className="bg-white rounded-lg shadow-sm overflow-hidden transition-shadow hover:shadow-md">
    ...
    />
    <div className="p-4">
      <h3 className="font-semibold text-gray-800 text-md mb-2 line-clamp-2 h-12">{course.title}</h3>
      <p className="text-sm text-gray-600 mb-2">Bởi {course.instructor}</p>
      
      <div className="flex items-center mb-3">
        <span className="text-sm font-bold text-yellow-500 mr-1">{course.rating}</span>
        <div className="flex text-yellow-500 text-xs">
          {[...Array(5)].map((_, i) => (
            <svg key={i} className={`w-4 h-4 ${i < Math.round(course.rating) ? 'fill-current' : 'text-gray-300'}`} viewBox="0 0 20 20">
              <path d="M10 15l-5.878 3.09 1.123-6.545L.489 6.91l6.572-.955L10 0l2.939 5.955 6.572.955-4.756 4.635 1.123 6.545z" />
            </svg>
          ))}
        </div>
        <span className="text-xs text-gray-600 ml-2">({course.students.toLocaleString()} HV)</span>
      </div>
    ...
    <div className="border-t border-gray-100 pt-4 mt-auto">
      <div className="flex items-center space-x-3">
        ...
        <div className="flex-1">
          ...
          <span className="text-xs text-gray-500">Học viên {review.course}</span>
        </div>
        <div className="flex text-yellow-500">
          {[...Array(review.rating)].map((_, i) => (
            <svg key={i} className="w-3 h-3 fill-current" viewBox="0 0 20 20">
...
const HeaderBanner = () => (
  <div className="bg-gradient-to-r from-[#106c54] to-[#0f7a5c] text-white rounded-xl shadow-lg p-8 md:p-12 mb-10">
    ...
    <p className="text-lg text-gray-200">Hãy tiếp tục hành trình học tập của bạn và khám phá những điều mới mẻ.</p>
  </div>
);
...
const EnrollmentLearn: React.FC = () => {
  ...
  return (
    <>
      <HomeLayout>
        <div className="min-h-screen bg-gray-100"> {/* Thay đổi bg-gray-50 thành bg-gray-100 để tăng độ tương phản */}
          <div className="max-w-7xl mx-auto p-6 md:p-8">
            ...
            <div className="bg-white rounded-lg shadow-lg p-6 md:p-8 mb-12">
              <h2 className="text-2xl font-semibold text-gray-800 mb-6 flex items-center">
                {/* Icon sách */}
                <svg className="w-6 h-6 mr-3 text-[#106c54]" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
            ...
            <div className="mb-12">
              <div className="flex justify-between items-center mb-6 px-2">
                <h2 className="text-2xl font-semibold text-gray-800 flex items-center">
                  {/* Icon ngôi sao */}
                  <svg className="w-6 h-6 mr-3 text-yellow-500" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
            ...
            <div>
              <div className="flex justify-between items-center mb-6 px-2">
                <h2 className="text-2xl font-semibold text-gray-800 flex items-center">
                  {/* Icon bình luận */}
                  <svg className="w-6 h-6 mr-3 text-blue-500" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
