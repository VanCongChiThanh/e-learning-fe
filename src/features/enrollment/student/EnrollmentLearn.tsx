...
//   const handleContinueLearning = (enrollmentId: UUID, courseId: UUID) => {
...
//       {selectedEnrollment &&
//         showSessionLearn  && currentCourseId && (
//           <SessionLearn
//             courseId={currentCourseId as UUID}
//             enrollmentId={selectedEnrollment as UUID}
...
const EnrollmentLearn: React.FC = () => {
  ...
  // Fetch courses cho tất cả enrollments
  useEffect(() => {
    const loadCourses = async () => {
      ...
      const courseIds = enrollments
        .map(e => e.courseId)
        .filter(id => id && !coursesMap[id]); // Chỉ fetch những course chưa có
