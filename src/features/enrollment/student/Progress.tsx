...
// import { useQuizzesByLecture } from "../hook/useQuizOperations";
...
//   // const { quizzes, loading: quizzesLoading } =
//   //   useQuizzesByLecture(selectedLectureId);
...
//   if (progressError) {
//     return <ErrorMessage message={progressError} className="m-6" />;
//   }
...
//           value={`${
//             progressList?.completionDate
//               ? new Date(progressList.completionDate).toLocaleDateString()
//               : "Chưa hoàn thành"
//           }`}
//           color="#8b5cf6"
//           icon={
