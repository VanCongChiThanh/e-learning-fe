...
import { getQuizSubmissionById, QuizSubmissionResponse } from '../api/quizAttempt';
      ...
      <div className="max-w-4xl mx-auto px-4 py-8">
        ...
        <div className="bg-white rounded-lg shadow-lg p-8 mb-6">
          <div className="text-center">
            ...
            <div className="text-4xl font-bold mb-2">
              <span className={submission.isPassed ? 'text-green-600' : 'text-red-600'}>
        ...
        <div className="grid md:grid-cols-2 gap-6 mb-6">
          <div className="bg-white rounded-lg shadow-sm p-6">
            <h3 className="font-semibold text-gray-900 mb-4">Thông tin bài quiz</h3>
          ...
          <div className="bg-white rounded-lg shadow-sm p-6">
            ...
            <div className="space-y-3">
              <div className="flex justify-between">
                ...
                <span className="font-medium">{formatDateTime(submission.startedAt)}</span>
              </div>
              <div className="flex justify-between">
        ...
        <div className="bg-white rounded-lg shadow-sm p-6 mb-6">
          <div className="flex items-center justify-between mb-2">
            ...
            <span className="text-sm text-gray-500">{submission.scorePercentage.toFixed(1)}%</span>
          </div>
          ...
          <div className="flex justify-between mt-2 text-xs text-gray-500">
            <span>0%</span>
            <span className="text-amber-600">{quiz.passingScore}% (Điểm qua)</span>
            <span>100%</span>
          </div>
        </div>
        ...
        <div className="bg-white rounded-lg shadow-sm p-6 mb-6">
          ...
          >
            <h3 className="font-semibold text-gray-900">Xem chi tiết từng câu hỏi</h3>
            <svg 
        ...
        <div className="flex justify-center space-x-4">
          ...
          {!submission.isPassed && quiz.maxAttempts && submission.attemptNumber < quiz.maxAttempts && (
            <button
              onClick={() => navigate(`/learn/quiz/${quizId}/${enrollmentId}`)}
